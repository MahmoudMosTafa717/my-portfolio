              ...
              >
                ...
                <div className="flex w-full flex-col justify-center lg:w-2/5">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    {project.github && (
                      <a href={project.github} target="_blank" rel="noreferrer" className="group flex items-center justify-center rounded-full border border-zinc-200 bg-transparent p-3 text-zinc-600 transition-colors hover:bg-zinc-100 dark:border-zinc-800 dark:text-zinc-400 dark:hover:bg-zinc-900 dark:hover:text-white">
        ...
        >
          <a href={PROFILE_DATA.contact.github} target="_blank" rel="noreferrer" className="bezel-shell group flex w-full max-w-2xl items-center justify-between transition-transform duration-500 hover:scale-[1.02]">
            <div className="bezel-core flex w-full items-center justify-between p-6 sm:p-8">
              ...
              <ExternalLink className="h-6 w-6 text-zinc-400 transition-transform duration-300 group-hover:translate-x-1 group-hover:-translate-y-1 group-hover:text-zinc-900 dark:group-hover:text-white" />
            </div>
          </a>
        </motion.div>
      </div>
